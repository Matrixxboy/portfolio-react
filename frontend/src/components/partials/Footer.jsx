...
const Footer =()=>{
    return (
        <div className="mx-auto px-6 py-8 text-center glass-white text-color-secondary border border-white/10">
    <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-7 gap-8 text-left">
        ...
        <div className="lg:col-span-2 text-center lg:text-left">
            ...
            <ul className="mt-4 space-y-2 text-sm flex flex-col lg:items-start items-center">
                ...
                <li><a href="../pages/aboutpage/Aboutpage.jsx" className="hover:underline text-purple-200">About Me</a></li>
                <li><a href="../pages/projectpage/Projects.jsx" className="hover:underline text-purple-200">Projects</a></li>
                <li><a href="../pages/certificatepage/Certificatepage.jsx" className="hover:underline text-purple-200">Certificates</a></li>
                <li><a href="../pages/blogpage/Blog.jsx" className="hover:underline text-purple-200">Blogs</a></li>
            </ul>
        </div>
        ...
        <div className="lg:col-span-5 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="space-y-4 text-center sm:text-left">
                ...
                <div className="flex items-center justify-center sm:justify-start space-x-2">
                    <a href="linkedin.com/in/utsav-lankapati-aa407b307/" target="_blank" className="text-color-primary hover:text-white">
                    ...
                    <a href="linkedin.com/in/utsav-lankapati-aa407b307/" target="_blank" className="hover:text-white">LinkedIn</a>
                </div>
            ...
            <div className="space-y-4 text-center sm:text-left">
                ...
                <div className="flex items-center justify-center sm:justify-start space-x-2">
                    ...
                    <a href="#" className="hover:text-white">Snapchat</a>
                </div>
            </div>
    ...
    <div className="flex flex-col sm:flex-row items-center justify-center mt-10 px-4">
        ...
        <div className="flex items-center mt-4 sm:mt-0 sm:ml-4 text-sm text-purple-300 space-x-2 text-center sm:text-left">
            <a href="../pages/conatactform/Contactform.jsx" className="mx-auto px-6 py-2 text-lg font-semibold text-purple-100 bg-white/10 rounded-md backdrop-blur-md transition duration-300 hover:bg-purple-400/10 hover:shadow-[0_0_12px_2px_rgba(168,85,247,0.4)] animate-pulse hover:animate-none">
                Contact Now
            </a>
  ...
  {/* <!-- Divider --> */}
    ...
    <div className="flex flex-wrap justify-center gap-6 mb-4">
        <a href="./footerpages/PrivacyPolicy.jsx" className="hover:text-white transition-colors duration-200">Privacy Policy</a>
        <span className="hidden sm:inline">|</span>
        <a href="./footerpages/TermsAndConditions.jsx" className="hover:text-white transition-colors duration-200">Terms of Service</a>
        <span className="hidden sm:inline">|</span>
        <a href="./footerpages/CookiePolicy.jsx" className="hover:text-white transition-colors duration-200">Cookie Policy</a>
        <span className="hidden sm:inline">|</span>
        <a href="./footerpages/DNSMD.jsx" className="hover:text-white transition-colors duration-200">Do Not Sell My Data</a>
        <span className="hidden sm:inline">|</span>
        <a href="./footerpages/GDPRI_info.jsx" className="hover:text-white transition-colors duration-200">GDPR Information</a>
    </div>
