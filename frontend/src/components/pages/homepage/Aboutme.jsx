      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-start">
        <div className="md:col-span-2 space-y-4">
          <p className="text-sm md:text-base leading-relaxed text-gray-300">
            ...
            <span className="font-medium" style="color: #BBAED0;">creativity and teamwork</span> to the next level.
          ...
          <p className="text-sm md:text-base leading-relaxed text-gray-300">
            ...
            but also brings <span className="font-semibold" style="color: #BBAED0;">real value</span> to people through technology.
          </p>
        </div>
